...
export const ModelSelectorModal: React.FC<ModelSelectorModalProps> = ({ isOpen, onClose }) => {
  ...
  const currentModel = externalModels.find((m) => m.id === activeModelId) || externalModels[0] || availableModels[0];
      ...
      <div className="flex items-center justify-between border-b border-neutral-800/80 pb-3 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-neutral-400">External AI tool accounts available for task delegation</p>
          </div>
        </div>
        <button
          type="button"
